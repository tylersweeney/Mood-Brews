    $(document).ready(function(){
      ...
      // $.ajax({
      //   url:'https://api-us.faceplusplus.com/facepp/v3/detect?api_key=ymxM1PfpEkuIniAcXSR6o9tUFCk1Uqo4&api_secret=n6KLZyFDrjsbFycCzxBs-ifyTNuyjZf8&image_file='+img+'&return_attributes=age,gender,smiling,emotion,ethnicity,eyestatus,beauty',
      //   method: 'POST'
      // }).done(function(response){
      //   console.log(response)
      // })
